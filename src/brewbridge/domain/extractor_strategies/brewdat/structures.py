...
class MigrationItem(BaseModel):
    ...
    bronze_config: Optional[Dict[str, Any]] = Field(None, description="Parameters for load_to_bronze")
    silver_config: Optional[Dict[str, Any]] = Field(None, description="Paremeters for load_to_silver")
