...
class ADFClient:
    ...
    def __init__(self, tenant_id: str, client_id: str, client_secret: str, subscription_id: Optional[str] = None):
        """
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            logger.warning(f"Azure Data Factory ping failed with status code: {response.status_code}")
            return False
